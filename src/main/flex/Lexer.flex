/*++
Modified 3/31/18 - added static compatLexer method.
...
import static com.avaglir.jetbrains.nasmplugin.psi.NASMTypes.*;
...
%{
  ...
  public static com.intellij.lexer.Lexer compatLexer() {
    return new com.intellij.lexer.FlexAdapter(new com.avaglir.jetbrains.nasmplugin.Lexer());
  }
%}
